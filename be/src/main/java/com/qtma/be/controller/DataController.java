            ...
            if (user.isPresent()) {
                ...
                if (userCourseOpt.isPresent()) {
                    ...
                    return userCourse.getCourses().stream().map(course -> {
                        ...
                        courseMap.put("requiredResouces", course.getCourseInfo().getCategory());
                        courseMap.put("attendanceAndLate", course.getCourseInfo().getCategory());
                        courseMap.put("gradingPolicy", course.getCourseInfo().getCategory());
                        courseMap.put("teachingAssistantInfo", course.getCourseInfo().getCategory());
