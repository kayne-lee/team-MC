...
export default function Home() {
    return (
        <div className="flex flex-col background min-h-screen">
            ...
            <div className="flex flex-row justify-between w-full flex-grow mb-16 pb-52">
            ...
            <div className="date-selector w-full h-52 flex items-center justify-center fixed bottom-0 mx-auto">
